...
void ALU::ProcessInternal()
{
	...
	case ALU_SELECT_ADD: lResult = lRD1 + lRD2; break;
	case ALU_SELECT_SUB: lResult = lRD1 - lRD2; break;
	case ALU_SELECT_XOR: lResult = lRD1 ^ lRD2; break;
	case ALU_SELECT_OR: lResult = lRD1 | lRD2; break;
	case ALU_SELECT_AND: lResult = lRD1 & lRD2; break;
	case ALU_SELECT_SLL: lResult = lRD1 << lRD2; break;
	case ALU_SELECT_SRL: lResult = lRD1 >> lRD2; break;
	case ALU_SELECT_SRA:
